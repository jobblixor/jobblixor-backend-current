...
# === ENV DEBUGGING BLOCK START ===
print("==== DEBUG ENV VARS ON RENDER ====")
for k in os.environ:
    print(f"{k}: {os.environ[k]}")
print("==== END DEBUG ====")

serp_api_key = os.environ.get("SERP_API_KEY")
print("SERP_API_KEY value is:", serp_api_key)
if serp_api_key is None:
    raise Exception("SERP_API_KEY is missing! Check Render Environment variable spelling and redeploy.")
# === ENV DEBUGGING BLOCK END ===
